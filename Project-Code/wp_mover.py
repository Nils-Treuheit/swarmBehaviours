...
## @file wp_mover.py
#  @brief An algorithm to move waypoints in paparazzi.
#  @details This implementation is used to change or update the attraction or repel points of the aircrafts during the simulation.
